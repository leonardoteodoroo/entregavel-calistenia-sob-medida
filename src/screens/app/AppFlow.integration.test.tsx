...
describe('MVP app flow', () => {
  ...
  it(
    'executa onboarding até conclusão do treino e atualiza progresso',
    async () => {
      renderFlow();
      ...
      fireEvent.click(screen.getByRole('button', { name: /confirmar e seguir/i }));
      ...
      expect(await screen.findByText(/treino escolhido para hoje/i)).toBeInTheDocument();

      fireEvent.click(screen.getByRole('button', { name: /iniciar treino de hoje/i }));
      ...
      fireEvent.click(screen.getByRole('button', { name: /salvar e ver progresso/i }));
