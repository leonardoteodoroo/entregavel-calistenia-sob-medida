...
export const faqItems: FaqItem[] = [
  {
    ...
    answer:
      "Não. Retome no próximo dia útil com o modo leve para manter consistência.",
  },
  {
    question: "Sinto desconforto no joelho. O que fazer?",
    answer:
      "Ative modo de baixo impacto e prefira adaptações com menor amplitude.",
  },
  {
    question: "Não tenho barra. Consigo seguir?",
    answer:
      "Sim. A biblioteca e o assistente sempre mostram substituições sem equipamento.",
  },
  {
