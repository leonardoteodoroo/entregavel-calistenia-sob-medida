...
import { 
  Menu, ArrowLeft, MoreVertical, Calendar, Droplet, Leaf, Trees, 
  FlaskConical, Snowflake, Sun, Waves, Target, Zap, User, Flower2, Sparkles, MoveRight, MoveLeft
} from 'lucide-react';

export default function App() {
  const [activeTab, setActiveTab] = useState<'apothecary' | 'ritual'>('apothecary');
      ...
      <div className="w-full max-w-[420px] h-[100dvh] md:h-[850px] bg-bg-warm md:rounded-[40px] md:shadow-2xl overflow-hidden relative flex flex-col">
        ...
        <nav className="absolute bottom-0 w-full z-50 rounded-t-[2rem] bg-bg-warm/90 backdrop-blur-xl shadow-[0_-12px_24px_-4px_rgba(27,28,28,0.06)]">
          <div className="flex justify-around items-center px-4 pb-8 pt-4">
            ...
            >
              <Sparkles size={20} strokeWidth={activeTab === 'apothecary' ? 2 : 1.5} />
              <span className="text-[10px] uppercase tracking-widest font-semibold mt-1">Focus</span>
            </button>
            <button 
            ...
            >
              <Flower2 size={20} strokeWidth={activeTab === 'ritual' ? 2 : 1.5} />
              <span className="text-[10px] uppercase tracking-widest font-semibold mt-1">Rituals</span>
            </button>
            <button className="flex flex-col items-center justify-center text-stone-400 hover:text-primary-dark transition-all scale-90 duration-500">
              ...
              <span className="text-[10px] uppercase tracking-widest font-semibold mt-1">Apothecary</span>
            </button>
            <button className="flex flex-col items-center justify-center text-stone-400 hover:text-primary-dark transition-all scale-90 duration-500">
              <User size={20} strokeWidth={1.5} />
              <span className="text-[10px] uppercase tracking-widest font-semibold mt-1">Profile</span>
            </button>
          </div>
        </nav>
      </div>
    ...
    <div className="animate-in fade-in duration-500">
      ...
      <nav className="sticky top-0 w-full z-40 bg-bg-warm/80 backdrop-blur-xl">
        <div className="flex items-center justify-between px-6 h-16 w-full">
          ...
          <span className="text-xl font-serif text-primary-dark tracking-tight italic">Apothecary</span>
      ...
      <main className="pt-8 pb-12 px-6">
        ...
        <header className="mb-12">
          ...
          <h1 className="font-serif text-[2.75rem] font-light text-stone-900 leading-[1.1] mb-6">
            Mapping the <span className="italic font-medium text-primary-dark">Self</span>
          </h1>
          <p className="text-stone-600 text-lg leading-relaxed max-w-[90%]">
            A curation of botanical wisdom designed to recalibrate your internal landscape through the art of essential oils.
          </p>
        </header>

        {/* Emotional Hotspots Grid */}
        <section className="mb-16">
          <h2 className="font-serif text-2xl mb-8 ml-1 text-stone-900">Emotional Hotspots</h2>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="aspect-square bg-card-1 rounded-2xl p-5 flex flex-col justify-between group cursor-pointer hover:bg-stone-200 transition-all duration-500">
              <div className="flex justify-between items-start">
                <Waves className="text-primary-dark group-hover:scale-110 transition-transform" size={24} strokeWidth={1.5} />
                <span className="text-[10px] font-bold uppercase tracking-widest text-stone-500">01</span>
              </div>
              <div>
                <h3 className="font-serif text-2xl mb-1 text-stone-900">Anxiety</h3>
                <p className="text-xs text-stone-600 font-medium">Grounding Rituals</p>
              </div>
            </div>
            ...
            <div className="aspect-square bg-card-2 rounded-2xl p-5 flex flex-col justify-between text-white group cursor-pointer hover:opacity-90 transition-all duration-500 mt-8">
              <div className="flex justify-between items-start">
                <Target className="group-hover:scale-110 transition-transform" size={24} strokeWidth={1.5} />
                <span className="text-[10px] font-bold uppercase tracking-widest opacity-70">02</span>
              </div>
              <div>
            ...
            <div className="aspect-square bg-card-3 rounded-2xl p-5 flex flex-col justify-between text-stone-800 group cursor-pointer hover:opacity-90 transition-all duration-500 -mt-8">
              <div className="flex justify-between items-start">
                <Sun className="group-hover:scale-110 transition-transform" size={24} strokeWidth={1.5} />
                <span className="text-[10px] font-bold uppercase tracking-widest opacity-70">03</span>
              </div>
              <div>
                <h3 className="font-serif text-2xl mb-1">Fatigue</h3>
                <p className="text-xs opacity-80 font-medium">Vibrant Essence</p>
              </div>
            </div>
            ...
            <div className="aspect-square bg-card-4 rounded-2xl p-5 flex flex-col justify-between group cursor-pointer hover:bg-stone-300 transition-all duration-500">
              <div className="flex justify-between items-start">
                <Zap className="text-stone-700 group-hover:scale-110 transition-transform" size={24} strokeWidth={1.5} />
                <span className="text-[10px] font-bold uppercase tracking-widest text-stone-500">04</span>
              </div>
              <div>
                <h3 className="font-serif text-2xl mb-1 text-stone-900">Motivation</h3>
                <p className="text-xs text-stone-600 font-medium">Ignite Purpose</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16 -mx-6 px-6 overflow-hidden">
          <div className="flex justify-between items-end mb-6">
            <h2 className="font-serif text-2xl text-stone-900">The Botanical Shelf</h2>
        ...
        <section className="mb-16">
          <div className="bg-card-1 rounded-3xl overflow-hidden p-8 flex flex-col gap-8 items-center">
            <div className="relative w-32 h-48 flex-none">
              <svg className="w-full h-full fill-primary-light/50" viewBox="0 0 200 400">
            ...
            <div className="flex-1 space-y-6 w-full">
              <h2 className="font-serif text-[2rem] leading-tight text-stone-900">
                Metabolism <br/><span className="italic text-primary-dark">Activation Points</span>
              </h2>
              <ul className="space-y-5">
                <li className="flex gap-4">
                  <span className="text-stone-500 font-bold text-lg">01</span>
                  <div>
                    <p className="font-bold text-sm text-stone-900">Solar Plexus</p>
                    <p className="text-xs text-stone-600 mt-1">Apply Grapefruit oil in circular motions to stimulate digestive warmth.</p>
                  </div>
                </li>
                <li className="flex gap-4">
                  <span className="text-primary-dark font-bold text-lg">02</span>
                  <div>
                    <p className="font-bold text-sm text-stone-900">Pulse Points</p>
                    <p className="text-xs text-stone-600 mt-1">Ginger essence on wrists to invigorate systemic flow.</p>
                  </div>
                </li>
              </ul>
            </div>
        ...
        <section className="mb-8">
          <div className="bg-card-2 p-10 rounded-3xl text-center overflow-hidden relative">
            ...
            <h2 className="font-serif text-3xl text-white mb-4 relative z-10">Craft Your Personal Alchemist Routine</h2>
            <p className="text-primary-light/80 text-sm mb-8 relative z-10 max-w-sm mx-auto">
              Get a tailored selection of oils based on your biological rhythm and goals.
            </p>
...
function BotanicalCard({ name, tag, img }: { name: string, tag: string, img: string }) {
  return (
    <div className="snap-start flex-none w-56 bg-white rounded-2xl p-3 shadow-sm border border-stone-100">
      <div className="aspect-[4/5] rounded-xl overflow-hidden mb-4 relative">
        ...
        <span className="absolute bottom-3 left-4 text-white font-serif text-xl">{name}</span>
      </div>
      <div className="flex justify-between items-center px-1">
        <span className="text-[10px] text-stone-500 font-bold tracking-wider">{tag}</span>
    ...
    <div className="animate-in fade-in duration-500">
      ...
      <nav className="sticky top-0 w-full z-40 bg-bg-warm/80 backdrop-blur-xl">
        <div className="flex items-center justify-between px-6 h-16 w-full">
          ...
          <span className="text-xl font-semibold text-primary-dark font-serif tracking-tight italic">The Ritual</span>
      ...
      <main className="pt-6 pb-12 px-6">
        ...
        <section className="mb-10">
          <div className="mb-8">
            ...
            <p className="text-stone-600 mt-3 text-lg">Anti-Cellulite Protocol No. 2</p>
          </div>
        ...
        <section className="mb-12">
          <div className="bg-card-1 p-5 rounded-3xl flex items-center gap-5">
            ...
            <div>
              <p className="text-[10px] font-bold text-stone-500 uppercase tracking-widest mb-1">Recommended Frequency</p>
              <p className="text-2xl font-serif font-semibold text-primary-dark">2x per week</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="flex items-baseline justify-between mb-6">
            <h3 className="text-[1.75rem] font-serif italic text-stone-900">The Composition</h3>
            <span className="text-[10px] font-bold text-stone-500 tracking-wider uppercase">55.5ml Total</span>
          </div>
          
          <div className="space-y-3">
            <div className="flex items-center p-4 bg-white rounded-2xl shadow-sm border border-stone-100">
              <Droplet className="text-primary-dark/70 mr-4 shrink-0" size={20} strokeWidth={1.5} />
              <div className="flex-1">
                <p className="text-stone-900 font-medium text-sm">30ml Fractionated Coconut Oil</p>
                <p className="text-xs text-stone-500 mt-0.5">Carrier Base</p>
              </div>
            </div>
            <div className="flex items-center p-4 bg-white rounded-2xl shadow-sm border border-stone-100">
              <Leaf className="text-primary-dark/70 mr-4 shrink-0" size={20} strokeWidth={1.5} />
              <div className="flex-1">
                <p className="text-stone-900 font-medium text-sm">15 drops Grapefruit</p>
                <p className="text-xs text-stone-500 mt-0.5">Detoxifying & Invigorating</p>
              </div>
            </div>
            <div className="flex items-center p-4 bg-white rounded-2xl shadow-sm border border-stone-100">
              <Leaf className="text-primary-dark/70 mr-4 shrink-0" size={20} strokeWidth={1.5} />
              <div className="flex-1">
                <p className="text-stone-900 font-medium text-sm">10 drops Rosemary</p>
                <p className="text-xs text-stone-500 mt-0.5">Circulatory Support</p>
              </div>
            </div>
            <div className="flex items-center p-4 bg-white rounded-2xl shadow-sm border border-stone-100">
              <Trees className="text-primary-dark/70 mr-4 shrink-0" size={20} strokeWidth={1.5} />
              <div className="flex-1">
                <p className="text-stone-900 font-medium text-sm">10 drops Eucalyptus</p>
        ...
        {/* Preparation Bento */}
        <section className="mb-12">
          <h3 className="text-[1.75rem] font-serif italic text-stone-900 mb-6">Preparation</h3>
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-card-1 p-6 rounded-3xl col-span-2">
              <FlaskConical className="text-stone-500 mb-4" size={24} strokeWidth={1.5} />
              <p className="text-stone-800 leading-relaxed text-sm">
                Combine all ingredients in a sterile <span className="text-primary-dark font-semibold">glass dropper bottle</span>. Swirl gently to integrate the botanical essences with the carrier oil.
              </p>
            </div>
            <div className="bg-card-3/40 p-5 rounded-3xl">
              <Snowflake className="text-stone-700 mb-3" size={20} strokeWidth={1.5} />
              <p className="text-xs text-stone-700 font-medium leading-relaxed">Store in a cool, dark sanctuary.</p>
            </div>
            <div className="bg-card-4/50 p-5 rounded-3xl">
              <Sun className="text-stone-700 mb-3" size={20} strokeWidth={1.5} />
              <p className="text-xs text-stone-700 font-medium leading-relaxed">Keep away from direct sunlight.</p>
            </div>
          </div>
        </section>
        ...
        {/* Application Guide */}
        <section className="mb-12">
          <h3 className="text-[1.75rem] font-serif italic text-stone-900 mb-8">The Application</h3>
          <div className="space-y-10">
            {/* Step 1 */}
            <div className="flex gap-5 items-start">
              <div className="w-10 h-10 rounded-full bg-stone-200 shrink-0 flex items-center justify-center font-serif italic text-xl text-primary-dark">1</div>
              <div>
                <h4 className="font-serif text-xl text-stone-900 mb-2">Dispense & Prepare</h4>
                <p className="text-stone-600 text-sm leading-relaxed">Dispense 5-10 drops into your palms. Notice the aroma as it activates with the air.</p>
              </div>
            </div>
            
            {/* Step 2 */}
            <div className="flex gap-5 items-start">
              <div className="w-10 h-10 rounded-full bg-stone-200 shrink-0 flex items-center justify-center font-serif italic text-xl text-primary-dark">2</div>
              <div>
                <h4 className="font-serif text-xl text-stone-900 mb-2">Warm & Emulsify</h4>
                <p className="text-stone-600 text-sm leading-relaxed">Warm by rubbing hands together and massage into affected areas using firm, circular motions.</p>
              </div>
            </div>

            {/* Step 3 */}
            <div className="flex gap-5 items-start">
              <div className="w-10 h-10 rounded-full bg-stone-200 shrink-0 flex items-center justify-center font-serif italic text-xl text-primary-dark">3</div>
              <div className="w-full">
                <h4 className="font-serif text-xl text-stone-900 mb-2">Guided Massage</h4>
                <p className="text-stone-600 text-sm leading-relaxed mb-4">Use the body massager with consistent pressure to stimulate lymphatic drainage.</p>
            ...
            {/* Step 4 */}
            <div className="flex gap-5 items-start">
              <div className="w-10 h-10 rounded-full bg-stone-200 shrink-0 flex items-center justify-center font-serif italic text-xl text-primary-dark">4</div>
              <div>
                <h4 className="font-serif text-xl text-stone-900 mb-2">Absorption</h4>
                <p className="text-stone-600 text-sm leading-relaxed">Let the oils absorb for a few minutes before dressing. Experience the gentle tingling sensation.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-10 text-center border-t border-stone-200/60">
          <p className="font-serif italic text-stone-500 text-lg">Elevating the mundane to the sacred.</p>
        </section>
      </main>
    </div>
  );
